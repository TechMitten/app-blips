...
export default function PromptInput({
  ...
  return (
    <div data-tour="prompt" className="prompt-input-dock bg-white dark:bg-[#161824] rounded-2xl border-2 border-slate-400 dark:border-white/20 overflow-hidden transition-all shadow-md flex flex-col">
      {attachment && (
