  ...
  return (
    <Modal zIndex={65}>
      <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
        <h2 className="text-base 2xl:text-lg font-semibold text-slate-900">Name Your {noun}</h2>
        <button
          type="button"
          onClick={onCancel}
      ...
      <form onSubmit={onConfirm} className="p-6 space-y-5">
        <div className="space-y-3">
          <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">{noun} Name</label>
