---
title: "AppBlips FAQ: Building Apps, AI, Exporting, and More"
sidebarTitle: "FAQ"
...
<AccordionGroup>
  <Accordion title="What kind of apps can AppBlips build?">
    AppBlips generates single-file React and HTML apps. That covers a wide range of practical and creative projects: interactive tools, mini-games, dashboards, habit trackers, forms, quizzes, calculators, data visualizers, and more.
