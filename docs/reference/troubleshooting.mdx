...
<AccordionGroup>
  ...
  <Accordion title="Build hangs and never completes">
    ...
    **Try the following:**
    ...
    3. If **Reasoning: building** is set to High in Settings, try switching it to Low — reasoning takes longer and is more likely to hit timeouts on slower providers.
  </Accordion>
