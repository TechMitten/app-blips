...
<AccordionGroup>
  ...
  <Accordion title="Build hangs and never completes">
    ...
    **Try the following:**
    ...
    3. If **Reasoning: building** or **Reasoning: editing** is on in Settings, try turning it off — reasoning takes longer and is more likely to hit timeouts on slower providers.
  </Accordion>
