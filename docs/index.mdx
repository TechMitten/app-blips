---
title: "AppBlips Docs: From Idea to Working App"
sidebarTitle: "Home"
description: "AppBlips turns plain-English descriptions into working single-file HTML apps and multi-page websites with a live preview. Get started in seconds, no coding required."
---

Welcome to AppBlips — the fastest way to turn an idea into a real, working app or website. Describe what you want in plain English, watch it build live in your browser, and walk away with a single HTML file or a ZIP of pages you can use anywhere. AppBlips is available as a hosted service at [appblips.com](https://appblips.com) (sign in and build instantly, no setup required) or as a self-hosted deployment you run on your own machine with your own API key.
...
<CardGroup cols={2}>
  ...
  <Card title="Self-Hosted Setup" icon="server" href="/quickstart-self-hosted">
    Run your own copy of AppBlips on your computer with Node.js or Docker, using your own AI provider key.
  </Card>
...
<Steps>
  ...
  <Step title="Export or deploy">
    Download your app or website as a single HTML file or a ZIP of pages to host or share anywhere. On the hosted service you can also publish it to its own public URL as an installable PWA.
  </Step>
</Steps>
...
<CardGroup cols={3}>
  ...
  <Card title="Export & deploy" icon="rocket">
    Apps and websites export as a single HTML file or a ZIP of pages, ready to host anywhere. On appblips.com you can also publish to a public URL in one click.
  </Card>
</CardGroup>
